...
<body>
	...
	<div class="bootstrap-iso">
		<div class="container">
			<h1>Relatório de hospitais cadastrados</h1>
			<table class="table table-bordered">
				...
				<tbody>
					...
					<TR>
						...
						<TD>
							<form method="post"
								action="http://localhost:8080/Consultorio2/ControladorHospital">
								<a
									href="http://localhost:8080/Consultorio2/telas/edit_hospital.jsp?idHospital=<%=rs.getInt(1)%>"><button
										type="button" class="btn btn-default">
										<span class="glyphicon glyphicon-pencil" aria-hidden="true">
									</button></a> <input type="hidden" name="idFormulario" value="4"> <input
									type="hidden" name="idHospital" value="<%=rs.getInt(1)%>">
