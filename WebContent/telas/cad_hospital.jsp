						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="nome" name="nome"
									placeholder="nome do hospital" type="text" />
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="endereco" name="endereco"
									placeholder="endere&ccedil;o do hospital" type="text" />
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="bairro" name="bairro"
									placeholder="bairro do hospital" type="text" />
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="cidade" name="cidade"
									placeholder="cidade do hospital" type="text" />
							</div>
						</div>
						<div class="form-group ">
						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="pais" name="pais"
									placeholder="digite o pais do hospital" type="text" />
							</div>
						</div>
						<div class="form-group">
