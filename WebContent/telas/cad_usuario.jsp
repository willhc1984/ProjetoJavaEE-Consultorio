			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-6 col-xs-12">
					<div class="formden_header">
						<h2>Cadastro de usu&aacute;rio de sistema</h2>
						<p></p>
					</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="nome" name="nome"
									placeholder="nome do usuario" type="text" />
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="especialidade" name="login"
									placeholder="login do usuario" type="text" />
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="col-sm-10">
								<input class="form-control" id="senha" name="senha"
									placeholder="digite uma senha" type="password" />
							</div>
						</div>
						<div class="form-group ">
